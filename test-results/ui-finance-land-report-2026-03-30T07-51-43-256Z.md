...
- Thoi gian: 2026-03-30T07:51:43.257Z
- Tong so checkpoint: 128
- PASS: 128
- FAIL: 0
...
| CREATE | NguonThu | UI-THU-57041597 | UI-THU-57041597 | PASS |  |
...
| CREATE | HangMucChi | UI-CHI-HM-57049378 | UI-CHI-HM-57049378 | PASS |  |
...
| CREATE | PhuongThuc | Chuyển khoản | Chuyển khoản | PASS |  |
| CREATE | SoChungTu | CT-57049378 | CT-57049378 | PASS |  |
...
| Phase | Field | Expected | Actual | Status | Note |
|---|---|---|---|---|---|
| CREATE | TenDuAn | UI-DA-57055955 | UI-DA-57055955 | PASS |  |
...
| Phase | Field | Expected | Actual | Status | Note |
|---|---|---|---|---|---|
| CREATE | TenBaoCao | UI-BC-57061996 | UI-BC-57061996 | PASS |  |
...
| CREATE | MaThua | TDBD57068141 | TDBD57068141 | PASS |  |
...
| CREATE | LyDo | LYDO-57068141 | LYDO-57068141 | PASS |  |
...
| Phase | Field | Expected | Actual | Status | Note |
|---|---|---|---|---|---|
| CREATE | MaThua | TDCSD57076744 | TDCSD57076744 | PASS |  |
...
| CREATE | MaThua | TDTC57091218 | TDTC57091218 | PASS |  |
...
| CREATE | NoiDung | Noi dung TC 57091218 | Noi dung TC 57091218 | PASS |  |
